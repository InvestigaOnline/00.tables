...
En la siguiente tabla, filtramos la tabla para aquellos entrevistados que han declarado tener hijos `(P34  == 1)` por un lado y los que no popr otro `(P34 == 2)`. Para ello usamos la instrucción [`tab_subgroup()`](https://rdrr.io/cran/expss/man/tables.html) e introducimos también la instrucción [`tab_row_label()`](https://rdrr.io/cran/expss/man/tables.html) donde escribimos una fila con texto libre. Puedes consultar en el capítulo \@ref(tse08) como se escriben las condiciones y cuáles son los operadores que se pueden utilizar `expss`además tiene algunos opetradores propios que en este mismo capítulo incluiremos.
