---
title: "Tablas y graficos con R y R Studio"
author: "Roberto Gil Saura<br><br>![](data/portada.png)"
...
df <-suppressMessages(read_csv("~/R/r-projects/00.tables/data/df.csv", col_names =TRUE))
edges <-suppressMessages(read_csv("~/R/r-projects/00.tables/data/edges.csv",locale = locale(encoding = "ISO-8859-1")))
names <-suppressMessages(read_csv("~/R/r-projects/00.tables/data/names.csv",locale = locale(encoding = "ISO-8859-1")))
```
...
© Textos y gráficos: Roberto Gil-Saura ([robertogil\@investigaonline.com](mailto:robertogil@investigaonline.com){.email})
...
1ª edición: Valencia, 2021 ISBN: 978-84-09-29382-7 Última actualización: `r Sys.Date()`
...
```{r fig.cap="Frecuencias marginales de P31, estilo SPSS", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
tab <- fre(data$P31)
...
```{r fig.cap="Frecuencias marginalesde P31 en tabla", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
...
```{r fig.cap="Frecuencias de P31", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
  tab_cells(P31) %>%
  tab_stat_cases() %>%
  tab_pivot())
...
```{r fig.cap="Frecuencias de P31, moviendo el Total", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P31) %>% 
...
```{r fig.cap="Porcentajes de P31", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P31) %>% 
...
```{r fig.cap="Frecuencias y porcentajes de P31", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P31) %>% 
  tab_stat_cases(total_row_position = "above", label = "Casos") %>%
...
```{r fig.cap="Tablas con propiedades diferentes a estándar", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P31) %>% 
  tab_stat_cases(total_row_position = "above", label = "Casos") %>% 
  tab_stat_cpct(label = "% casos") %>% 
...
```{r fig.cap="Propiedades diferentes al estándar", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P31) %>% 
...
```{r fig.cap="Frecuencias de P18", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
...
```{r fig.cap="Frecuencias y porcentajes de P18 (1)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
...
```{r fig.cap="Frecuencias y porcentajes de P18 (2)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(mdset_f(P18C)) %>%  # o tab_cells(mdset(P18C01 %to% P18C08))
  tab_stat_cases(label ="Casos") %>% 
  tab_stat_cpct(label="% casos") %>% 
...
```{r fig.cap="Frecuencias y porcentajes de P18 (3)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(mdset_f(P18C)) %>%  # o tab_cells(mdset(P18C01 %to% P18C08))
  tab_stat_cases(label ="Casos") %>% 
  tab_stat_cpct(label="% casos") %>% 
...
```{r fig.cap="Frecuencias y porcentajes de P18 (4)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(mdset_f(P18C)) %>%  # o tab_cells(mdset(P18C01 %to% P18C08))
  tab_stat_cases(label ="Casos") %>% 
  tab_stat_cpct(label="% casos") %>% 
...
```{r fig.cap="Estadísticos marginales de P3 (1)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P3) %>% 
  tab_stat_mean() %>% 
  tab_stat_sd() %>% 
...
```{r fig.cap="Estadísticos marginales de P3 (2)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P3) %>% 
...
```{r fig.cap="Estadísticos marginales de P3 (3)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data%>%
  tab_cells(P3) %>% 
  tab_stat_mean(label = "media") %>% 
  tab_stat_sd(label = "desviación") %>% 
...
```{r fig.cap="Estadísticos marginales de P3 (4)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P3) %>% 
...
```{r fig.cap="Estadísticos marginales de P3 (5)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P3) %>% 
  tab_stat_mean(label = "Media") %>% 
  tab_stat_sd(label =  "Desviación") %>%  
...
```{r fig.cap="Estadísticos marginales de P3 (6)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P3) %>% 
  tab_stat_mean(label = "Media") %>% 
  tab_stat_sd(label =  "Desviación") %>%  
...
```{r fig.cap="Estadísticos marginales de P3 (7)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
  tab_cells(P3) %>% 
  tab_stat_mean(label = "Media") %>% 
  tab_stat_sd(label =  "Desviación") %>%  
...
```{r fig.cap="Campos con los que trabajar", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
suppressMessages(setwd("~/R/r-projects/00.tables")) #esta es la carpeta donde almacené el archivo (en una subcarpeta llamada data)
suppressMessages(library(expss)) #cargamos el paquete
suppressMessages(data <- read_spss("data/3192.sav")) #cargamos los datos
data$P3
...
```{r fig.cap="Cruce de estado civil por sexo", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
...
```{r fig.cap="Cruce de estado civil por sexo, porcentaje de columna", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
...
```{r fig.cap="Cruce de estado civil por sexo, porcentaje de fila", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
...
```{r fig.cap="Cruce de estado civil por sexo, porcentaje sobre el total de la muestra", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
...
```{r fig.cap="Combinación de casos y porcentajes dentro de las columnas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
    tab_stat_cases(label = "Casos") %>%
...
```{r fig.cap="Combinación de casos y porcentajes por tipo de estadístico en columnas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
    tab_stat_cases(label = "Casos") %>%
...
```{r fig.cap="Combinación de casos y porcentajes dentro de las filas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
    tab_stat_cases(label = "Casos") %>%
...
```{r fig.cap="Combinación de casos y porcentajes, por tipo de estadístico en filas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P33) %>%
    tab_cols(total(), P31) %>%
    tab_stat_cases(label = "Casos") %>%
...
```{r fig.cap="Cruce de motivos guardar envases enteros por sexo", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
...
```{r fig.cap="Cruce de motivos guardar envases enteros por sexo, porcentaje de columna", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(mdset(P21A01 %to% P21A03)) %>%
    tab_cols(total(), P31) %>%
    tab_stat_cpct(total_row_position = "above", total_label = "Total") %>% # aquí señalo los porcentajes de columna
...
```{r fig.cap="Cruce de motivos guardar envases enteros por sexo, porcentaje de fila", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(mdset(P21A01 %to% P21A03)) %>%
    tab_cols(total(), P31) %>%
    tab_stat_rpct(total_row_position = "above", total_label = "Total") %>% # aquí señalo los porcentajes de fila
...
```{r fig.cap="Cruce de motivos guardar envases enteros por sexo, porcentaje sobre el total de la muestra", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(mdset(P21A01 %to% P21A03)) %>%
    tab_cols(total(), P31) %>%
    tab_stat_tpct(total_row_position = "above", total_label = "Total") %>% # aquí señalo los porcentajes total muestra
...
```{r fig.cap="Cruce entre variable y estadísticos", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Transposición de tabla", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
...
```{r fig.cap="Estadísticos dentro de columnas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Estadísticos dentro de las filas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Estadísticos separados en columnas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Estadísticos separados en filas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Uso de variable base (anidación)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Filas con estadístico fuera de filas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Filas con estadístico dentro de las filas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Filas con estadísticos dentro de las columnas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Filas con estadísticos fuera de las columnas", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), P31) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (1)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (2)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (3)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (4)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (5)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (6)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_stat_mean(label = "Media") %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (7)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (8)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (9)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (10)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_rows(P33) %>%
...
```{r fig.cap="Cruce con múltiple y estadístico (11)", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
    tab_cells(P3) %>%
    tab_cols(total(), mdset(P21A01 %to% P21A03)) %>%
    tab_rows(P33) %>%
...
library(dplyr)
library(expss)
suppressMessages(data <- read_spss("~/R/r-projects/00.tables/data/3192.sav")) #cargamos los datos
data$CUES <- unvl(data$CUES)
```
...
De forma muy sencilla, podemos obtener de nuestro fichero de datos lo que se denomina el *codeplan* [@mohler2008survey] o libro de códigos. `expss` tiene una orden directa para ello. Este libro de códigos nos permitirá de forma muy sencilla conocer de primera mano, con mayor o menor precisión, de forma exploratoria el contenido de nuestro banco de datos o en definitva la codificación que se ha utilizado.
...
```{r 6030, fig.cap='Ejemplos de recodificación 1', out.width='80%', fig.asp=.75, fig.align = 'center', echo = TRUE}
...
```{r 6040, fig.cap = "Ejemplos de recodificación 2", out.width = "95%", fig.asp =.95, fig.align = "center", echo = TRUE}
...
```{r 6050, fig.cap="Cuadros de baterías", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>%
...
```{r 6060, fig.cap="Cuadros de baterías modificado", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
     c(
          "1" = 1,
          "2" = 2,
...
```{r 6080, fig.cap="Uso de ponderación con multi respuesta", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
as.datatable_widget(data %>% 
    tab_cols(total(),P3 ) %>%
    tab_weight(PESO) %>%
    tab_cells(mdset(P21A01 %to% P21A03)) %>% 
...
```{r 6090, fig.cap="Cálculo de la eficiencia del peso", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
...
```{r 6100, fig.cap="Uso de subtotales 1", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6110, fig.cap="Uso de subtotales 2", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6120, fig.cap="Uso de nets 1", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6130, fig.cap="Uso de nets 2", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6140, fig.cap="Uso de top y bottom", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6150, fig.cap="Uso de top y bottom arriba", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6160, fig.cap="Uso de top y bottom abajo", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
```{r 6170, fig.cap="Uso de top y bottom sin los valores agrupados", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
val_lab(data$P901) <-
    c(
        "1" = 1,
        "2" = 2,
...
Dejamos además aquí esta `pildora adictiva` adelantándonos a la sección \@ref(tse08). Vamos a crear el primer gráfico en este libro. Vamos a repetir la tabla anterior, pero la guardamos en un objeto llamado `tab`. Limpiamos además aquello que no nos interesa, lo convertimos y lo publicamos en su formato bruto o estándar, es decir como *dataframe*.

```{r 6180, fig.cap="Uso de gráfico highcharter 1", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
tab <- data %>%
    tab_cols("|" = unvr(P31)) %>%
    tab_cells("|" = unvr(P901)) %>%
    tab_net_cells(
...
```{r 6190, fig.cap="Uso de gráfico highcharter 2", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE}
suppressMessages(library(highcharter, quietly = TRUE))
highchart() %>%
...
```{r 7000, fig.cap="Prueba Chi<sup>2</sup> en tabla", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
as.datatable_widget(
  data %>%
...
```{r 7010, fig.cap="Prueba Chi<sup>2</sup>", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
...
```{r 7020, fig.cap="Prueba Chi<sup>2</sup> de celda", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
as.datatable_widget(
  data %>%
    tab_cols(total(), "|" = unvr(P31)) %>%
    tab_cells("|" = unvr(P2)) %>%
...
```{r 7030, fig.cap="Prueba Z en tabla", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
as.datatable_widget(
  data %>%
...
```{r 7040, fig.cap="Prueba t en tabla", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
as.datatable_widget(
  data %>%
    tab_cols(
      total(),
...
```{r 7050, fig.cap="Prueba t con sólo medias", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
as.datatable_widget(
  data %>%
    tab_cols(
      total(),
...
-   `inequality_sign` lógico. FALSE si `subtable_marks` es menor o mayor. Debemos mostrar \> o \< antes de las marcas de importancia de las comparaciones de subtabla.
-   `sig_labels` etiquetas de vector de caracteres para marcar diferencias entre columnas de subtabla.
-   `sig_labels_previous_column` un vector de caracteres con dos elementos. Etiquetas para marcar una diferencia con la columna anterior. La primera marca significa menor (por defecto es v) y la segunda significa mayor (\^).
-   `sig_labels_first_column` un vector de caracteres con dos elementos. Etiquetas para marcar una diferencia con la primera columna de la tabla. La primera marca significa menor (por defecto es -) y la segunda significa mayor (+).
-   `sig_labels_chisq` un vector de caracteres con dos etiquetas para marcar una diferencia con el margen de fila de la tabla. La primera marca significa menor (por defecto es \<) y la segunda significa mayor (\>). Solo para Meaning_cell_chisq.
...
-   `x` table (`class etable`): resultado de `cro_cpct` con proporciones y bases para `significance_cpct`, resultado de `cro_mean_sd_n` con medias, desviaciones estándar y N válido para `significance_means`, y resultado de `cro_cases` con recuentos y bases para `significance_cases`.
...
```{r fig.cap="Prueba Chi<sup>2</sup> con significación al 99%", out.width="95%", fig.asp=.95, fig.align="center", echo = TRUE, warning = FALSE}
as.datatable_widget(
  data %>%
    tab_cols(total(), "|" = unvr(P31)) %>%
    tab_cells("|" = unvr(P33)) %>%
...
## Conclusión al uso del paquete expss
...
```{r 8010, fig.cap='Tabla de ejemplo para uso en highcharter', fig.align = 'center', echo=FALSE, message = FALSE, warning = FALSE}
knitr::kable(df) %>%
     kable_styling(
...
```{r 8020, fig.cap='Gráfico inicial de barras', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8030, fig.cap='Gráfico de barras de tabla original', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'bar') %>%
...
```{r 8040, fig.cap='Gráfico de barras, adición nombre serie', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'bar') %>%
  hc_xAxis(categories = df1$name) %>%
...
```{r 8050, fig.cap='Gráfico de barras, adición de créditos', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'bar') %>%
  hc_xAxis(categories = df1$name) %>%
  hc_add_series(df1, name = 'Fruits') %>%
...
```{r 8060, fig.cap='Gráfico de barras, adición de valores', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'bar') %>%
  hc_xAxis(categories = df1$name) %>%
...
```{r 8070, fig.cap='Gráfico de barras, adición de exportación', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'bar') %>%
  hc_xAxis(categories = df1$name) %>%
  hc_add_series(df1, name = 'Fruits', dataLabels = list(enabled = TRUE)) %>%
...
Para eso tenemos lo que se llama la API de la librería de gráficos. Ahora entenderemos mejor el apartado de presentación cuando decíamos que `highcharter` es unwrapperde la librería `Highcharts` . Si visitamos el sitio web de la [api de highcharts](https://api.highcharts.com) podemos ver que todas las opciones que se pueden usar en los gráficos están documentadas. Si a ello añadimos el [sitio demo](https://highcharts.com/demo) de esta marca podemos ver todo lo que se puede hacer. Te recomiendo la lectura del [post de Danton Noriega](https://dantonnoriega.github.io/ultinomics.org/posts/2017-04-05-highcharter-explainer.html) acerca de como usar la API para saber construir nuestros gráficos de `Highchart` en R, en especial la parte en la que refiere a este punto que estamos hablando `(Highcharts API and highcharter functions)`. Tras la lectura de ese post te darás cuenta de que en tus manos de analista de datos, tienes un auténtico cañón de magníficas visualizaciones. Pero vayamos poco a poco y continuemos con nuestros ejemplos de gráficos.
...
```{r 8080, fig.cap='gráfico de columnas', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8090, fig.cap='Gráfico de columnas 3D', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'column',
           options3d = list(
             enabled = TRUE,
...
```{r 8100, fig.cap='Gráfico de columnas con pirámides', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8110, fig.cap='Gráfico lollipop o dumbbell', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8120, fig.cap='Gráfico lollipop invertido', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8130, fig.cap='Gráfico de barras, circular -polar-', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8140, fig.cap='Gráfico de barras circular con fijación de ángulo de parada', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'bar', polar = TRUE) %>%
  hc_xAxis(categories = df1$name) %>%
  hc_add_series(df1, name = 'Fruits', dataLabels = list(enabled = TRUE)) %>%
...
```{r 8150, fig.cap='Gráfico de tarta y adición de secciones separadas', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8160, fig.cap='Gráfico de doughnut', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_title(text = 'Fruits pie') %>%
  hc_subtitle(text = 'My favourite fruits') %>%
  hc_chart(type = 'pie',
...
```{r 8170, fig.cap='Gráfico dedoughnut, adelgazado', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_title(text = 'Fruits pie') %>%
  hc_subtitle(text = 'My favourite fruits') %>%
  hc_chart(type = 'pie',
...
```{r 8180, fig.cap='Gráfico de funnel', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8190, fig.cap='Gráfico de pirámide', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8200, fig.cap='Gráfico de línea', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
knitr::kable(df)
```
...
```{r 8210, echo = TRUE, warning = FALSE, message = FALSE}
df1 <-
...
```{r 8220, fig.cap='Gráfico de línea multi serie (1)', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'line') %>%
  hc_xAxis(categories = df1$name) %>%
...
```{r 8230, fig.cap='Gráfico de línea multi serie (2)', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
  hc_chart(type = 'line') %>%
  hc_xAxis(categories = df1$name) %>%
...
```{r 8240, fig.cap='Gráfico de línea suavizado', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8250, fig.cap='Gráfico combinado línea y columna', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'line') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(df1$y, name = 'Fruits - serie 1', dataLabels = list(enabled =
...
```{r 8260, fig.cap='Gráfico combinado polarizado', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8270, fig.cap='Gráfico de tela de araña', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'line',
              polar = TRUE,
...
```{r 8280, fig.cap='Gráfico de columnas apiladas', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
df1 <-
...
```{r 8290, fig.cap='Gráfico de columnas apiladas, adición de color', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'column') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8300, fig.cap='Gráfico columnas combinando apilamiento y normal', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'column') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8310, fig.cap='Gráfico de columnas combinando apilamiento porcentual', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'column') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8320, fig.cap='Gráfico de barras con apilamiento porcentual', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'bar') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8330, fig.cap='Gráfico de columnas apiladas porcentual', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8340, fig.cap='Gráfico de área', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'area') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8350, fig.cap='Gráfico de área apilado', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'area') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8360, fig.cap='Gráfico de área apilado porcentual', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'area') %>%
     hc_xAxis(categories = df1$name) %>%
     hc_add_series(
...
```{r 8370, fig.cap='Gráfico de puntos, scatter', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8380, fig.cap='Scatterplot, preparación', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8390, fig.cap='Scatterplot', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8400, fig.cap='Scatterplot', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8410, fig.cap='Bubble scatterplot', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8420, fig.cap='Histograma', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8430, fig.cap='Gráfico de densidad', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
...
```{r 8440, fig.cap='Gauge o indicador', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
col_stops <-
     data.frame(
          q = c(0.25, 0.50, 0.75),
...
```{r 8450, fig.cap='Gauge', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
col_stops <-
     data.frame(
          q = c(0.25, 0.50, 0.75),
          c = c('#CD5C5C', '#F0E68C', '#3CB371'),
...
Otra forma de representar valores unitario pero que tienen un objetivo definido y que pueden haber superado ese objetivo es el gráfico denominado *bullet*. vamos a imaginar que en nuestro *dataframe* , el campo `y`es el valor alcanzado, y el campo `value` es el objetivo.

```{r 8460, fig.cap='Bullet o indicador lineal', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
bandas <-
  list(
...
Nótese que en el gráfico la barra vertical perpendicular a cada barra horizontal, que es el `target` se toma de los propios datos. Es un gráfico que también se ve mucho en losdashboard\_, al igual que el anterior.
...
```{r 8470, fig.cap='Boxplot', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
dfboxplot1 <-
     data_to_boxplot(df,
                     value,
                     add_outliers = TRUE,
...
```{r 8480, fig.cap='Boxplot con series', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
dfboxplot1 <-
     data_to_boxplot(df,
                     value,
                     add_outliers = TRUE,
...
```{r 8490, fig.cap='Gráfico de barras error', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8500, fig.cap='Gráfico de barras error con punto', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
     hc_chart(type = 'errorbar',
              polar = FALSE,
              inverted = FALSE) %>%
...
```{r 8510, fig.cap='Gráfico de Sankey', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8520, fig.cap='Gráfico de rueda', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8530, fig.cap='Streamgraph', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
highchart() %>%
...
```{r 8540, fig.cap='Diagrama network, redes de influencia', fig.align = 'center', echo = TRUE, warning = FALSE, message = FALSE, comment = NA}
